...
public class Instituto_Querys 
{
	...
	public void ingresarInst(String IdI, String NI, String NEI, String NII, String NCI, String CI, String MI) throws IOException 
	{
		try 
		{
	...
	public void eliminarInst(String IdI) throws IOException 
	{
		try 
		{
			cn = conexion.conectar();
	...
	public void modificarInst(String IdI, String NI, String NEI, String NII, String NCI, String CI, String MI) throws IOException 
	{
		try 
		{
			cn = conexion.conectar();
